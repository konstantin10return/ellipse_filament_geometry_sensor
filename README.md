Модуль для <a href="https://github.com/Klipper3d/klipper">Klipper</a>. Позволяет добавить поддержку датчика геометрии филамента, учитывающего овальность.
...
# precision: 100
# Точность вычисления большей полуоси. Чем больше значение этого параметра,
